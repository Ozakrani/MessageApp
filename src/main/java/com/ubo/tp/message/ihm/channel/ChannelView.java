...
public class ChannelView extends JPanel {
    ...
    private void initGUI() {
        ...
        boolean isPrivate = mChannel.getUsers() != null
                && !mChannel.getUsers().isEmpty();
        ...
        mJoinButton.setBorder(BorderFactory.createLineBorder(
                new Color(100, 180, 100), 1, true));
    ...
    public void addJoinListener(ActionListener l)  { mJoinButton.addActionListener(l); }
